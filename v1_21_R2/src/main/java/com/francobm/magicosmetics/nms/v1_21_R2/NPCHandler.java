...
public class NPCHandler extends NPC {
    ...
    public void spawnPunch(Player player, Location location) {
        ...
        PacketPlayOutSpawnEntity packetPlayOutSpawnEntity = new PacketPlayOutSpawnEntity(entityPunch.ar(), entityPunch.cG(), location.getX(), location.getY(), location.getZ(), location.getPitch(), location.getYaw(), entityPunch.aq(), 0, entityPunch.dz(), entityPunch.cA());
    ...
    public void spawnNPC(Player player) {
        ...
        PacketPlayOutSpawnEntity npcSpawnPacket = new PacketPlayOutSpawnEntity(npc.ar(), npc.cG(), npcLocation.getX(), npcLocation.getY(), npcLocation.getZ(), npcLocation.getPitch(), npcLocation.getYaw(), npc.aq(), 0, npc.dz(), npc.cA());
        PacketPlayOutSpawnEntity armorStandSpawnPacket = new PacketPlayOutSpawnEntity(armorStand.ar(), armorStand.cG(), armorStandLocation.getX(), armorStandLocation.getY(), armorStandLocation.getZ(), armorStandLocation.getPitch(), armorStandLocation.getYaw(), armorStand.aq(), 0, armorStand.dz(), armorStand.cA());
    ...
    public void balloonNPC(Player player, Location location, ItemStack itemStack, boolean bigHead){
        ...
        PacketPlayOutSpawnEntity balloonSpawnPacket = new PacketPlayOutSpawnEntity(balloon.ar(), balloon.cG(), balloonPos.getX(), balloonPos.getY(), balloonPos.getZ(), balloonPos.getPitch(), balloonPos.getYaw(), balloon.aq(), 0, balloon.dz(), balloon.cA());
        PacketPlayOutSpawnEntity leashedSpawnPacket = new PacketPlayOutSpawnEntity(leashed.ar(), leashed.cG(), balloonPosition.getX(), balloonPosition.getY(), balloonPosition.getZ(), balloonPosition.getPitch(), balloonPosition.getYaw(), leashed.aq(), 0, leashed.dz(), leashed.cA());
