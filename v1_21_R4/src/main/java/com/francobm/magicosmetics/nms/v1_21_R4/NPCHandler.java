...
public class NPCHandler extends NPC {
    ...
    public void spawnPunch(Player player, Location location) {
        ...
        PacketPlayOutSpawnEntity packetPlayOutSpawnEntity = new PacketPlayOutSpawnEntity(entityPunch.ao(), entityPunch.cG(), location.getX(), location.getY(), location.getZ(), location.getPitch(), location.getYaw(), entityPunch.an(), 0, entityPunch.dy(), entityPunch.cA());
        entityPlayer.f.b(packetPlayOutSpawnEntity);
        entityPlayer.f.b(new PacketPlayOutEntityHeadRotation(entityPunch, (byte) yaw));
        entityPlayer.f.b(new PacketPlayOutEntityMetadata(entityPunch.ao(), entityPunch.ar().c()));
    ...
    public void addNPC(Player player, Location location) {
        ...
        EntityArmorStand armorStand = new EntityArmorStand(EntityTypes.g, world);
        ...
        //balloon
        balloon = new EntityArmorStand(EntityTypes.g, world);
        balloon.n(true); //invulnerable true
        balloon.k(true); //Invisible true
        EntityArmorStand entityPunch = new EntityArmorStand(EntityTypes.g, world);
        entityPunch.n(true);
        entityPunch.k(true);
        ...
        leashed = new EntityPufferFish(EntityTypes.aY, world);
        ((EntityPufferFish)leashed).a_(npc, true);
        leashed.n(true);
        leashed.k(true);
    ...
    public void removeNPC(Player player) {
        ...
        connection.b(new PacketPlayOutEntityDestroy(armorStand.getEntityId(), entity.getEntityId(), punch.getEntityId(), balloon.ao(), leashed.ao()));
    }

    @Override
    public void removeBalloon(Player player) {
        PlayerConnection connection = ((CraftPlayer)player).getHandle().f;
        connection.b(new PacketPlayOutEntityDestroy(balloon.ao(), leashed.ao()));
    }
    ...
    public void spawnNPC(Player player) {
        ...
        PacketPlayOutSpawnEntity npcSpawnPacket = new PacketPlayOutSpawnEntity(npc.ao(), npc.cG(), npcLocation.getX(), npcLocation.getY(), npcLocation.getZ(), npcLocation.getPitch(), npcLocation.getYaw(), npc.an(), 0, npc.dy(), npc.cA());
        PacketPlayOutSpawnEntity armorStandSpawnPacket = new PacketPlayOutSpawnEntity(armorStand.ao(), armorStand.cG(), armorStandLocation.getX(), armorStandLocation.getY(), armorStandLocation.getZ(), armorStandLocation.getPitch(), armorStandLocation.getYaw(), armorStand.an(), 0, armorStand.dy(), armorStand.cA());
        ...
        //client settings
        entityPlayer.f.b(new PacketPlayOutEntityMetadata(armorStand.ao(), armorStand.ar().c()));
        //
        ...
        entityPlayer.f.b(new PacketPlayOutEntityMetadata(npc.ao(), watcher.c()));
        new BukkitRunnable() {
            @Override
            public void run() {
    ...
    public void lookNPC(Player player, float yaw) {
        ...
        connection.b(new PacketPlayOutEntity.PacketPlayOutEntityLook(armorStand.ao(), (byte)(yaw * 256 / 360), (byte)0, true));

        connection.b(new PacketPlayOutEntityHeadRotation(entityPlayer, (byte)(yaw * 256 / 360)));
        connection.b(new PacketPlayOutEntity.PacketPlayOutEntityLook(entityPlayer.ao(), (byte)(yaw * 256 / 360), (byte)0, true));
    ...
    public void armorStandSetItem(Player player, ItemStack itemStack) {
        ...
        connection.b(new PacketPlayOutEntityEquipment(entityPlayer.ao(), list));
    }
    ...
    public void balloonSetItem(Player player, ItemStack itemStack) {
        ...
        connection.b(new PacketPlayOutEntityEquipment(balloon.ao(), list));
    }
    ...
    public void balloonNPC(Player player, Location location, ItemStack itemStack, boolean bigHead){
        ...
        PacketPlayOutSpawnEntity balloonSpawnPacket = new PacketPlayOutSpawnEntity(balloon.ao(), balloon.cG(), balloonPos.getX(), balloonPos.getY(), balloonPos.getZ(), balloonPos.getPitch(), balloonPos.getYaw(), balloon.an(), 0, balloon.dy(), balloon.cA());
        PacketPlayOutSpawnEntity leashedSpawnPacket = new PacketPlayOutSpawnEntity(leashed.ao(), leashed.cG(), balloonPosition.getX(), balloonPosition.getY(), balloonPosition.getZ(), balloonPosition.getPitch(), balloonPosition.getYaw(), leashed.an(), 0, leashed.dy(), leashed.cA());
        realPlayer.f.b(balloonSpawnPacket);
        realPlayer.f.b(leashedSpawnPacket);
        realPlayer.f.b(new PacketPlayOutEntityMetadata(balloon.ao(), balloon.ar().c()));
        realPlayer.f.b(new PacketPlayOutEntityMetadata(leashed.ao(), leashed.ar().c()));
    ...
    public void addPassenger(Player player) {
        ...
        PacketPlayOutMount packetPlayOutMount = this.createDataSerializer(packetDataSerializer -> {
            packetDataSerializer.c(entityPlayer.ao());
            packetDataSerializer.a(new int[]{armorStand.ao()});
    ...
    public void addPassenger(Player player, net.minecraft.world.entity.Entity entity1, net.minecraft.world.entity.Entity entity2) {
        ...
        EntityPlayer p = ((CraftPlayer)player).getHandle();
        PacketPlayOutMount packetPlayOutMount = this.createDataSerializer(packetDataSerializer -> {
            packetDataSerializer.c(entity1.ao());
            packetDataSerializer.a(new int[]{entity2.ao()});
            return PacketPlayOutMount.a.decode(packetDataSerializer);
        });
        p.f.b(packetPlayOutMount);
    }
    ...
    public void animation(Player player){
        ...
        if (!rotateLoop) {
            rot += 0.01;
            balloon.a(new Vector3f(balloon.B().a() - 0.5f, balloon.B().b(), balloon.B().c() + rotate));
        ...
        p.f.b(new PacketPlayOutEntityMetadata(balloon.ao(), balloon.ar().c()));
        p.f.b(new PacketPlayOutEntityTeleport(leashed.ao(), PositionMoveRotation.a(leashed), Relative.j,  false));
        p.f.b(new PacketPlayOutEntityTeleport(balloon.ao(), PositionMoveRotation.a(balloon), Relative.j,  false));
    }
    ...
    public void animationBigHead(Player player){
        ...
        if (!rotateLoop) {
            rot += 0.01;
            balloon.d(new Vector3f(balloon.C().a() - 0.5f, balloon.C().b(), balloon.C().c() + rotate));
            //armorStand.setHeadPose(armorStand.getHeadPose().add(0, 0, rotate).subtract(0.008, 0, 0));
            if (rot > 0.20) {
                rotateLoop = true;
            }
