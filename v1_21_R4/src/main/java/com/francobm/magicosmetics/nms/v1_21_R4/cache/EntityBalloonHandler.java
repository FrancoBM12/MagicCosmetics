...
public class EntityBalloonHandler extends EntityBalloon {
    ...
    public void spawn(Player player) {
        ...
        if(!invisibleLeash) {
            entityPlayer.f.b(new PacketPlayOutAttachEntity(leashed, ((CraftEntity) getEntity()).getHandle()));
        }
        //client settings
    ...
    public void remove(Player player) {
        ...
        connection.b(new PacketPlayOutEntityDestroy(armorStand.ao(), leashed.ao()));
    ...
    public void update(){
        ...
        for(UUID uuid : players){
            ...
            if(!invisibleLeash) {
                p.f.b(new PacketPlayOutAttachEntity(leashed, ((CraftEntity) getEntity()).getHandle()));
            }
    ...
    public void rotate(boolean rotation, RotationType rotationType, float rotate) {
        ...
        switch (rotationType){
            case RIGHT:
                armorStand.a(new Vector3f(armorStand.A().a(), armorStand.A().b() + rotate, armorStand.A().c()));
                break;
            case UP:
                armorStand.a(new Vector3f(armorStand.A().a() + rotate, armorStand.A().b(), armorStand.A().c()));
                break;
            case ALL:
                armorStand.a(new Vector3f(armorStand.A().a() + rotate, armorStand.A().b() + rotate, armorStand.A().c()));
                break;
        }
        for(UUID uuid : players){
            Player player = Bukkit.getPlayer(uuid);
