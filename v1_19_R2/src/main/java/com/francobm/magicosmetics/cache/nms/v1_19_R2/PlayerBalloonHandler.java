...
public class PlayerBalloonHandler extends PlayerBalloon {
    ...
    public void spawn(Player player) {
        ...
        if(!invisibleLeash) {
            entityPlayer.b.a(new PacketPlayOutAttachEntity(leashed, ((CraftPlayer) owner).getHandle()));
        }
        //client settings
    ...
    public void lookEntity(float yaw, float pitch) {
        for (UUID uuid : players) {
            ...
            connection.a(new PacketPlayOutEntity.PacketPlayOutEntityLook(leashed.ah(), (byte) (yaw * 256 / 360), /*(byte) (pitch * 256 / 360)*/(byte)0, true));
        }
    }
    ...
    protected void instantUpdate() { //implement this method to others versions
        ...
        for(UUID uuid : players){
            ...
            if(!invisibleLeash) {
                p.b.a(new PacketPlayOutAttachEntity(leashed, ((CraftPlayer) owner).getHandle()));
            }
