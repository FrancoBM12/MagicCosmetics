package com.francobm.magicosmetics.nms.NPC.v1_19_R3;
...
public class NPCHandler extends NPC {
    ...
    public void spawnPunch(Player player, Location location) {
        ...
        entityPunch.aj().refresh(entityPlayer);
        EntityArmorStand passenger = new EntityArmorStand(EntityTypes.d, entityPlayer.H);
        passenger.m(true);
        passenger.j(true);
        passenger.b(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        entityPlayer.b.a(new PacketPlayOutSpawnEntity(passenger));
        passenger.aj().refresh(entityPlayer);
        PacketPlayOutMount packetPlayOutMount = this.createDataSerializer(packetDataSerializer -> {
            ...
            packetDataSerializer.a(new int[]{passenger.af()});
    ...
    public void removeEntity(Player player, Entity entity) {
        ...
        PlayerConnection connection = ((CraftPlayer)player).getHandle().b;
        connection.a(new PacketPlayOutEntityDestroy(e.af()));
    }

    @Override
    public void removeBalloon(Player player) {
        PlayerConnection connection = ((CraftPlayer)player).getHandle().b;
        connection.a(new PacketPlayOutEntityDestroy(balloon.af()));
    ...
    public void spawnNPC(Player player) {
        ...
        byte bitmask = ((CraftPlayer)player).getHandle().aj().a(new DataWatcherObject<>(17, DataWatcherRegistry.a));
    ...
    public void lookNPC(Player player, float yaw, float pitch) {
        ...
        connection.a(new PacketPlayOutEntity.PacketPlayOutEntityLook(entityPlayer.af(), (byte)(yaw * 256 / 360), (byte)(pitch * 256 / 360), true));
    ...
    public void addPassenger(Player player, Entity entity1, Entity entity2) {
        ...
        EntityPlayer p = ((CraftPlayer)player).getHandle();
        PacketPlayOutMount packetPlayOutMount = this.createDataSerializer(packetDataSerializer -> {
            packetDataSerializer.d(entity.af());
            packetDataSerializer.a(new int[]{armorStand.af()});
            return new PacketPlayOutMount(packetDataSerializer);
        });
        p.b.a(packetPlayOutMount);
    ...
    public void moveNPC(Player player, double x, double y, double z) {
        ...
        EntityPlayer p = ((CraftPlayer)player).getHandle();
        p.b.a(new PacketPlayOutEntity.PacketPlayOutRelEntityMove(npc.af(), (short)(x * 4096), (short)(y * 4096), (short)(z * 4096), true));
    }
    ...
    public void changeSkinNPC(Player player, String username) {
        ...
        try {
            ...
            if (connection.getResponseCode() == HttpsURLConnection.HTTP_OK) {
                ...
                entityPlayer.getBukkitEntity().getProfile().getProperties().put("textures", new Property("textures", skin, signature));
            }
        ...
        // The client settings.
        entityPlayer.aj().refresh(((CraftPlayer)player).getHandle());
