...
public class Utilities {
    ...
    public Utilities(String licenseKey, String validationServer, Plugin plugin) {
        this.licenseKey = licenseKey;
        this.plugin = plugin;
        this.validationServer = validationServer;
    }

    public Utilities setSecurityKey(String securityKey) {
        this.securityKey = securityKey;
        return this;
    }

    public Utilities setConsoleLog(LogType logType) {
        this.logType = logType;
        return this;
    }

    public Utilities debug() {
        debug = true;
        return this;
    }
