...
public class Sound {
    ...
    public static void loadSounds(){
        sounds.clear();
        FileCreator soundsConfig = CustomCosmetics.getInstance().getSounds();
        for(String key : soundsConfig.getConfigurationSection("sounds").getKeys(false)){
            ...
            if(soundsConfig.contains("sounds." + key + ".type")) {
                ...
                try{
                    ...
                    CustomCosmetics.getInstance().getLogger().info("Sound '" + sound + "' not Found in Bukkit... Transform custom");
                    soundCustom = sound;
                }
            }
