...
import com.francobm.customcosmetics.utils.Cuboid;
...
public class Zone {
    ...
    public static void loadZones(){
        zones.clear();
        FileCreator zone = CustomCosmetics.getInstance().getZones();
        ...
        for(String key : zone.getConfigurationSection("zones").getKeys(false)){
            ...
            if(zone.contains("zones." + key + ".corn1")){
                ...
                if(c1.equalsIgnoreCase("Location is Null!!")){
                    CustomCosmetics.getInstance().getLogger().info("Location of Corn1 is Null!");
                }else{
            ...
            if(zone.contains("zones." + key + ".corn2")){
                ...
                if(c2.equalsIgnoreCase("Location is Null!!")){
                    CustomCosmetics.getInstance().getLogger().info("Location of Corn2 is Null!");
                }else{
            ...
            if(zone.contains("zones." + key + ".npc")){
                ...
                if(npcString.equalsIgnoreCase("Location is Null!!")){
                    CustomCosmetics.getInstance().getLogger().info("Location of NPC is Null!");
                }else{
            ...
            if(zone.contains("zones." + key + ".enter")){
                ...
                if(enterString.equalsIgnoreCase("Location is Null!!")){
                    CustomCosmetics.getInstance().getLogger().info("Location of Enter is Null!");
                }else{
            ...
            if(zone.contains("zones." + key + ".exit")){
                ...
                if(exitString.equalsIgnoreCase("Location is Null!!")){
                    CustomCosmetics.getInstance().getLogger().info("Location of Exit is Null!");
                }else{
            ...
            if(zone.contains("zones." + key + ".balloon")){
                ...
                if(balloonString.equalsIgnoreCase("Location is Null!!")){
                   CustomCosmetics.getInstance().getLogger().info("Location of Balloon is Null!");
                }else{
    ...
    public ItemStack getCorn(){
        ...
        itemMeta.setDisplayName("§bSetea los puntos de la zona " + getName());
        List<String> lore = new ArrayList<>();
        lore.add("§eClick Izq para setear la primera posicion");
        lore.add("§eClick Der para setear la segunda posicion");
