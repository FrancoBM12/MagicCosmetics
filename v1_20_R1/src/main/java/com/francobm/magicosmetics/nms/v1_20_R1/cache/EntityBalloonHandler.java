...
public class EntityBalloonHandler extends EntityBalloon {
    ...
    public void spawn(Player player) {
        ...
        if(!invisibleLeash) {
            entityPlayer.c.a(new PacketPlayOutAttachEntity(leashed, ((CraftEntity) getEntity()).getHandle()));
        }
        //client settings
    ...
    public void update(){
        ...
        for(UUID uuid : players){
            ...
            if(!invisibleLeash) {
                p.c.a(new PacketPlayOutAttachEntity(leashed, ((CraftEntity) getEntity()).getHandle()));
            }
