...
public class NPCHandler extends NPC {
    ...
    public void spawnPunch(Player player, Location location) {
        ...
        entityPlayer.c.b(new PacketPlayOutEntityMetadata(entityPunch.al(), entityPunch.ap().c()));
    ...
    public void removeNPC(Player player) {
        ...
        connection.b(new PacketPlayOutEntityDestroy(armorStand.getEntityId(), entity.getEntityId(), punch.getEntityId(), balloon.al(), leashed.al()));
    }

    @Override
    public void removeBalloon(Player player) {
        PlayerConnection connection = ((CraftPlayer)player).getHandle().c;
        connection.b(new PacketPlayOutEntityDestroy(balloon.al(), leashed.al()));
    }
    ...
    public void spawnNPC(Player player) {
        ...
        //
        DataWatcher watcher = npc.ap();
        byte bitmask = ((CraftPlayer)player).getHandle().ap().a(new DataWatcherObject<>(17, DataWatcherRegistry.a));
        watcher.a(new DataWatcherObject<>(17, DataWatcherRegistry.a), bitmask);
        entityPlayer.c.b(new PacketPlayOutEntityMetadata(npc.al(), watcher.c()));
        new BukkitRunnable() {
            @Override
            public void run() {
    ...
    public void lookNPC(Player player, float yaw) {
        ...
        connection.b(new PacketPlayOutEntity.PacketPlayOutEntityLook(armorStand.al(), (byte)(yaw * 256 / 360), (byte)0, true));

        connection.b(new PacketPlayOutEntityHeadRotation(entityPlayer, (byte)(yaw * 256 / 360)));
        connection.b(new PacketPlayOutEntity.PacketPlayOutEntityLook(entityPlayer.al(), (byte)(yaw * 256 / 360), (byte)0, true));
    ...
    public void armorStandSetItem(Player player, ItemStack itemStack) {
        ...
        connection.b(new PacketPlayOutEntityEquipment(entityPlayer.al(), list));
    }
    ...
    public void balloonSetItem(Player player, ItemStack itemStack) {
        ...
        connection.b(new PacketPlayOutEntityEquipment(balloon.al(), list));
    }
    ...
    public void balloonNPC(Player player, Location location, ItemStack itemStack, boolean bigHead){
        ...
        realPlayer.c.b(new PacketPlayOutEntityMetadata(balloon.al(), balloon.ap().c()));
        realPlayer.c.b(new PacketPlayOutEntityMetadata(leashed.al(), leashed.ap().c()));
    ...
    public void addPassenger(Player player) {
        ...
        PacketPlayOutMount packetPlayOutMount = this.createDataSerializer(packetDataSerializer -> {
            packetDataSerializer.c(entityPlayer.al());
            packetDataSerializer.a(new int[]{armorStand.al()});
    ...
    public void addPassenger(Player player, net.minecraft.world.entity.Entity entity1, net.minecraft.world.entity.Entity entity2) {
        ...
        EntityPlayer p = ((CraftPlayer)player).getHandle();
        PacketPlayOutMount packetPlayOutMount = this.createDataSerializer(packetDataSerializer -> {
            packetDataSerializer.c(entity1.al());
            packetDataSerializer.a(new int[]{entity2.al()});
            return PacketPlayOutMount.a.decode(packetDataSerializer);
        });
        p.c.b(packetPlayOutMount);
    }
    ...
    public void animation(Player player){
        ...
        p.c.b(new PacketPlayOutEntityMetadata(balloon.al(), balloon.ap().c()));
