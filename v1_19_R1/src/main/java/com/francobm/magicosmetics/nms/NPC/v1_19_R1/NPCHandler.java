package com.francobm.magicosmetics.nms.NPC.v1_19_R1;
...
public class NPCHandler extends NPC {
    ...
    public void addNPC(Player player) {
        ...
        EntityPlayer npc = new EntityPlayer(server, world, gameProfile, null);
    ...
    public void balloonNPC(Player player, Location location, ItemStack itemStack, boolean bigHead){
        ...
        connection.a(new PacketPlayOutSpawnEntity(balloon));
        ...
        watcher2.b(new DataWatcherObject<>(4, DataWatcherRegistry.i), leashed.aM());
