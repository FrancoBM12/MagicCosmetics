...
public class PlayerBalloonHandler extends PlayerBalloon {
    ...
    public void spawn(Player player) {
        ...
        if(!invisibleLeash) {
            connection.sendPacket(new PacketPlayOutAttachEntity(leashed, ((CraftPlayer) owner).getHandle()));
        }
    ...
    protected void instantUpdate() { //implement this method to others versions
        ...
        for(UUID uuid : players){
            ...
            if(!invisibleLeash) {
                p.b.sendPacket(new PacketPlayOutAttachEntity(leashed, ((CraftPlayer) owner).getHandle()));
            }
